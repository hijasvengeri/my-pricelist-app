...
// const handleSaveAsPdf = async () => {
//   const tableElement = document.getElementById('myPriceTable'); // Your table container
//   if (!tableElement) return;

//   const canvas = await html2canvas(tableElement, {
//     scale: 3,        // Higher scale = better resolution
//     useCORS: true,   // To include images from URLs
//     allowTaint: true,
...
//   // Handle multi-page if table is longer than one page
...
//   pdf.save(`PriceList_${new Date().toISOString().slice(0,10)}.pdf`);
// };
